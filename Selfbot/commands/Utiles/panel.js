...
module.exports = {
    ...
    run: async (client, message) => {
        ...
        message.edit(client.language(
            `La panel a bien été crée: ${channel}`,
            `The pannel has been created: ${channel}`
        ));
    }
}
